      ...
      >
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="2" style="margin-left: 15px">
            <div>
              <button type="primary" size="small" @click="search()" class="css-button-shadow-border--green"
          ...
          <el-col :span="1">
            <div>
              <button type="success" size="small" @click="reset()" class="css-button-shadow-border--green"
    ...
    <div>
      <div style="text-align: left; margin-bottom: 15px">
        <button
          ...
          class="css-button-shadow-border--green"
        >
          <i class="el-icon-plus"></i>&nbsp;添加
        </button>
        <button type="danger" size="small" @click="removeAll()" class="css-button-shadow-border--red">
          <i class="el-icon-delete"></i>&nbsp;删除
        </button>
        <button type="success" size="small" class="css-button-shadow-border--green">
          <i class="el-icon-upload2"></i>&nbsp;导出
        </button>
        <button type="warning" size="small" class="css-button-shadow-border--green">
        ...
        <el-table-column label="操作" fixed="right" align="center">
          <template slot-scope="scope">
            <button
              ...
              class="css-button-shadow-border--yellow"
            >
            ...
            <button
              ...
              class="css-button-shadow-border--red"
            >
              <i class="el-icon-delete"></i>&nbsp;删除
            </button>
          </template>
...
.css-button-shadow-border--yellow:active {
  top: 2px;
}
</style>